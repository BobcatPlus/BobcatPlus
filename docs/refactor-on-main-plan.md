...
**Commits landed:** 3 of 9 (`3b9ccef`, `64c817d`, `021e87a`).
...
| 4 | ⬜ | — | Move `bg/constants.js`, `bg/cache.js`, `bg/session.js`, `bg/bannerApi.js` (incl. `searchCoursesBySubjects`), `bg/prereqs.js` (incl. `BPPerf` wiring). | Tests green + manual smoke: eligible list fills <3s. |
